...
<div class="list-group list-group-lg">
    <a href="#" class="list-group-item animated fadeInDown bg-warning-light">
        ...
        <h6 class="no-margin fs-sm"><strong>Jenny Wilington</strong></h6>
    ...
    <a href="#" class="list-group-item">
        ...
        <h6 class="no-margin fs-sm">Maikel Basso</h6>
    ...
    <a href="#" class="list-group-item">
        ...
        <h6 class="no-margin fs-sm">Ianus Arendse</h6>
    ...
    <a href="#" class="list-group-item">
        ...
        <i class="fa fa-circle pull-xs-right text-success mt-sm"></i>
        <h6 class="no-margin fs-sm">Valdemar Landau</h6>
    ...
    <a href="#" class="list-group-item mb-n-md">
        ...
        <h6 class="no-margin fs-sm">Rick Teagan</h6>
