...
<ul class="news-list stretchable">
    <li class="animated fadeInDown bg-warning-light">
        ...
        <div class="news-item-info">
            <h6 class="name no-margin mb-xs"><a href="#">Just now! Check update time</a></h6>
            <p class="fs-mini">
    ...
    <li>
        ...
        <div class="news-item-info">
            <h6 class="name no-margin mb-xs"><a href="#">First Human Colony on Mars</a></h6>
            <p class="fs-mini">
    ...
    <li>
        ...
        <div class="news-item-info">
            <h6 class="name no-margin mb-xs"><a href="#">Light Blue reached $300</a></h6>
            <p class="fs-mini">
    ...
    <li>
        ...
        <div class="news-item-info">
            <h6 class="name no-margin mb-xs"><a href="#">No more spying</a></h6>
            <p class="fs-mini">
